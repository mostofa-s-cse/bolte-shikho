...
**Interfaces:**
- Produces: Tailwind color tokens (`bg-surface`, `text-ink`, `bg-accent`, etc.) and font CSS variables (`--font-display`, `--font-sans`, `--font-bengali`) every later component uses. Dark mode via the `class` strategy (`dark:` variants), toggled by `next-themes`.
...
- [ ] **Step 2: Define color tokens and font families in Tailwind**
...
- [ ] **Step 3: Define the token values for light and dark mode**
...
:root {
  ...
  --color-surface-alt: 237 233 224;
  --color-ink: 24 27 36;
  --color-ink-muted: 96 101 117;
  --color-accent: 232 169 77;
  --color-accent-ink: 46 30 4;
  --color-border: 224 219 208;
  --color-good: 46 125 79;
  --color-bad: 178 59 59;
}

.dark {
  --color-surface: 15 23 41;
  --color-surface-alt: 24 33 54;
  --color-ink: 232 230 222;
  --color-ink-muted: 154 160 172;
  --color-accent: 232 169 77;
  --color-accent-ink: 27 18 0;
  --color-border: 45 55 79;
  --color-good: 79 190 124;
  --color-bad: 224 104 104;
}
...
- [ ] **Step 5: Create a placeholder site header (fleshed out in Task 12) so the layout compiles**
